...
export const TableHead = forwardRef<HTMLTableCellElement, ThHTMLAttributes<HTMLTableCellElement>>(({className,...props},ref)=><th ref={ref} className={cn('h-11 px-4 text-left align-middle text-theme-xs font-medium uppercase tracking-wide text-gray-500 dark:text-gray-400',className)} {...props}/>)
export const TableCell = forwardRef<HTMLTableCellElement, TdHTMLAttributes<HTMLTableCellElement>>(({className,...props},ref)=><td ref={ref} className={cn('p-4 align-middle text-gray-700 dark:text-gray-300',className)} {...props}/>)
