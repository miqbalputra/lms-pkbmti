...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        'fixed left-1/2 top-1/2 z-999999 grid w-[calc(100%-2rem)] max-w-2xl -translate-x-1/2 -translate-y-1/2 gap-4 rounded-2xl border border-gray-200 bg-white p-6 md:p-8 shadow-theme-lg animate-in fade-in-50 zoom-in-95 dark:border-gray-800 dark:bg-gray-900',
        className
      )}
      {...props}
    >
